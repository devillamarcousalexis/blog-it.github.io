<nav class="nav bg-[#004AAD] border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl bg-[#004AAD] flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden duration-500 bg-[#004AAD] w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 bg-[#004AAD] md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0   dark:border-gray-700">
                <li>
                ...
                <li>
                    <a href="{{ route('profile.edit') }}" class="block bg-[#004AAD] py-2 px-3 text-white  md:border-0  md:p-0 dark:text-white "><span class="text-lg font-concert bg-[#004AAD] hover:border-b-4 hover:pb-1 hover:duration-200 hover:text-white">Profile</span></a>
                </li>
                <li>
                    <a href="#" class="block bg-[#004AAD] py-2 px-3 text-white  md:border-0  md:p-0 dark:text-white "><span class="text-lg font-concert bg-[#004AAD] hover:border-b-4 hover:pb-1 hover:duration-200 hover:text-white">Settings</span></a>
                </li>
            </ul>
        </div>
    </div>
