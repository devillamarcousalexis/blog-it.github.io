...
<div class="p-10 md:p-20 grid grid-cols-1 gap-10 bg-[#91C8E4]">
    ...
    <div class="grid grid-cols-2 gap-0 items-center justify-between bg-transparent">
        <div class="bg-transparent">
            <p class="text-3xl md:text-5xl w-fit bg-transparent font-bold  text-white font-concert px-0">Category</p>
        </div>
        <div class="bg-transparent">
    ...
    <div
        class="flex flex-col border-4 border-[#4682A9] text-lg bg-gradient-to-r from-blue-300 to-[#B4ECFF] font-concert text-[#4682A9] pt-5 pl-10 pr-10 pb-10 rounded-lg ">
        <div class="flex justify-end items-start bg-white">
            <a href="{{ route('category.edit', $data->category_id) }}"
                class="bg-white text-blue-500 rounded-full px-2 ">
        ...
        <div class="flex flex-col w-full bg-white">
            <div class="h-fit">
                <p class="text-lg md:text-xl font-bold bg-white px-0 py-2">{{ $data->category_name }}</p>
            </div>
